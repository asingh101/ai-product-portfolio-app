    ...
    <main className="min-h-screen flex items-center justify-center bg-surface px-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          <div className="w-16 h-16 cta-gradient rounded-2xl flex items-center justify-center mx-auto mb-6">
        ...
        <div className="bg-surface-container-lowest rounded-2xl p-8 shadow-ambient">
          {error && (
            <div className="bg-error-container/20 text-error rounded-xl px-4 py-3 text-sm mb-6 text-center">
              {error}
            </div>
          )}
          ...
          <button
            ...
            disabled={signingIn}
            className="w-full bg-surface-container-low hover:bg-surface-container rounded-xl px-6 py-4 flex items-center justify-center gap-3 transition-colors text-sm font-bold font-[family-name:var(--font-headline)] disabled:opacity-50"
          >
            {signingIn ? (
          ...
          <p className="text-center text-xs text-on-surface-variant mt-6">
            Only the authorized administrator can access this console.
          </p>
        </div>
      </div>
    </main>
